      ...
      <div className="bg-white p-2.5 rounded-xl border border-slate-200 shadow-2xs flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2">
        <div className="flex rounded-lg bg-slate-100 p-1 flex-1 sm:flex-initial">
          ...
          >
            ...
            <span>Take Interactive Test (Human Participant)</span>
          </button>
          <button
          ...
          >
            ...
            <span>Automated Synthetic Batch Engine</span>
          </button>
        </div>

        <div className="text-[11px] text-slate-500 px-3 hidden md:block">
          {runtimeMode === "interactive" ? (
            <span className="text-emerald-700 font-medium">● Real-time user input & ms RT tracking active</span>
          ) : (
            <span className="text-slate-500">Synthetic deterministic runtime scaffold</span>
          )}
        </div>
      </div>
      ...
      {runtimeMode === "batch" && (
        <div className="space-y-6">
          ...
          <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-4">
            <div>
              <h2 className="text-lg font-semibold text-slate-900">Synthetic Batch Execution Engine</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="md:col-span-2 space-y-1.5">
                <label className="text-xs font-semibold text-slate-700">Measurement IDs (comma-separated)</label>
                <input
                  type="text"
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between items-center">
                  <label className="text-xs font-semibold text-slate-700">Trials per Measurement</label>
            ...
            <div className="pt-2 flex flex-wrap gap-3">
              ...
              >
                ...
                Run Current Session through Scientific Governance
              </button>
              ...
              >
                ...
                Run Persisted Session through Full Governance
              </button>
            </div>
          </div>
            ...
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-4">
              <div className="flex items-center justify-between">
                ...
                >
                  ...
                  {copiedSection === "runtime" ? "Copied" : "Copy JSON"}
                </button>
              </div>
          ...
          {govSessionOutput && (
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-4">
              <div className="flex items-center justify-between">
                <h3 className="font-semibold text-slate-900 text-sm">Session Governance Result</h3>
                <button
                ...
                >
                  ...
                  {copiedSection === "session-gov" ? "Copied" : "Copy JSON"}
                </button>
              </div>
              <div className="bg-slate-900 text-slate-100 p-4 rounded-lg font-mono text-xs max-h-60 overflow-y-auto">
          ...
          {persistedOutput && (
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-4">
              <div className="flex items-center justify-between">
                <h3 className="font-semibold text-slate-900 text-sm">Persisted Full Governance Result</h3>
                <button
                ...
                >
                  ...
                  {copiedSection === "persisted-gov" ? "Copied" : "Copy JSON"}
                </button>
              </div>
